...
🚀 **Live Demo:** Check out the live project here: [https://idyllic-daffodil-b325b9.netlify.app]
...
Venda Mone is a lightweight, browser-based cursor-tag game and moral test where you chase an anxious, emoji-based creature across a peaceful meadow. As you pursue it, its energy bar drains until it becomes completely exhausted, triggering a tense 7-second countdown where it pleads for its life.  The game presents you with a choice: show self-control and let the timer run out to ascend to Heaven—where you earn respect scores, karma ledgers, nice compliments, and points to unlock 20 unique quirky pets—or give in to temptation and click it to get dragged straight to Hell under Chaathan presiding, where you must type a sincere apology into a trial text box to escape.  Packed with interactive sound toggles, custom ambient music, sound effects, and a real horror audio sting on capture, it’s a fully self-contained HTML5 mini-game built with Tailwind CSS and vanilla JavaScript.
